...
public class AffectationHashMap {
    ...
    public void ajouterEmployeDepartement(Employe e, Departement d){
        e.setNom(d.getNomDepartement()); //to make sure the department of the employee is not different from the department itself.
        details.put(e, d);
    }

    public void afficherEmployesEtDepartements(){
        for(Map.Entry<Employe, Departement> entry : details.entrySet()){
            System.out.println(entry.getKey().getNom() + ", " + entry.getKey().getPrenom() + ": Department: " + entry.getValue().getNomDepartement());
        }
    }
    ...
    public void afficherEmployes(){
        ...
        while(iterator.hasNext()){
            System.out.println(iterator.next().getIdentifiant());
        }
    }
    ...
    public void afficherDepartments(){
        ...
        for(Departement d : departments){
            System.out.println(d.getId() + ", " + d.getNomDepartement());
        }
    }
